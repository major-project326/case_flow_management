...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    super.initState();
    _nameController.text = 'User Name'; // Default name
    _emailController.text = 'username@example.com'; // Default email
    _phoneController.text = '+91 9876543210'; // Default phone number
    _locationController.text = 'City, Country'; // Default location
  }
